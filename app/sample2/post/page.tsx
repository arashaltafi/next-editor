...
const Sample2Post = (props: PropsType) => {
    ...
    const handleSubmit = async () => {
        ...
        const res = await fetch(Address.EndPoints.sample2Post, {
            method: 'POST',
    ...
    return (
        <div className='w-full min-h-screen flex flex-col items-center justify-start gap-8 px-16 py-8'>
            <h1 className='w-full text-center text-5xl font-bold'>Sample 2 Post</h1>
